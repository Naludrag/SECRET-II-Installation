...
sudo apt install apache2 php libapache2-mod-php php-xml php-gd php-bcmath php-mbstring php-pgsql libpcre3 libpthread-workqueue0 zlibc fping openipmi snmpd snmp -y
...
sudo apt install zabbix-server-pgsql zabbix-frontend-php php7.4-pgsql zabbix-apache-conf zabbix-agent -y

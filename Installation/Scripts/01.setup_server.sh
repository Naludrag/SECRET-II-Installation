...
sudo tee /etc/schroot/chroot.d/focal.conf > /dev/null << 'EOF'
...
# Create chroot jail and install Ubuntu 20.04 (Focal Fossa)
sudo mkdir -p /srv/ltsp/focal
sudo debootstrap --arch=amd64 focal /srv/ltsp/focal/ http://archive.ubuntu.com/ubuntu/
